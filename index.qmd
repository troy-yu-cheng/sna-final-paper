...
```{r}
# Function to calculate metrics for a given CSV path and network type label
calculate_metrics <- function(csv_path, network_type, stage) {
  ...
  # Degree Centralization (Manual Calculation)
  deg_vals <- degree(net)
  if (length(deg_vals) > 0) {
    centralization <- (max(deg_vals) * (network.size(net) - 1) - sum(max(deg_vals) - deg_vals)) / 
...
| Network_Type          | Stage | Density  | Avg_Degree | Centralization | Transitivity |
|-----------------------|-------|----------|-------------|----------------|--------------|
| Co-Retweet            | 1     | 0.0407   | 9.04        | 0.0786         | 1.000        |
| Quote Path Co-Retweet | 1     | 0.0000   | 0.00        | 0.0000         | 1.000        |
| Reply Path Co-Retweet | 1     | 0.0000   | 0.00        | 0.0000         | 1.000        |
| Co-Retweet            | 2     | 0.0676   | 15.00       | 0.1325         | 1.000        |
| Quote Path Co-Retweet | 2     | 0.0676   | 15.00       | 0.1325         | 1.000        |
| Reply Path Co-Retweet | 2     | 0.0676   | 15.00       | 0.1325         | 1.000        |
| Co-Retweet            | 3     | 0.0045   | 1.00        | 0.0080         | 1.000        |
| Quote Path Co-Retweet | 3     | 0.0045   | 1.00        | 0.0080         | 1.000        |
| Reply Path Co-Retweet | 3     | 0.0045   | 1.00        | 0.0080         | 1.000        |
| Co-Retweet            | 4     | 0.0124   | 2.75        | 0.0237         | 1.000        |
| Quote Path Co-Retweet | 4     | 0.0092   | 2.04        | 0.0172         | 1.000        |
| Reply Path Co-Retweet | 4     | 0.0124   | 2.75        | 0.0237         | 1.000        |
| Co-Retweet            | 5     | 0.0042   | 0.93        | 0.0071         | 0.854        |
| Quote Path Co-Retweet | 5     | 0.0010   | 0.21        | 0.0015         | 1.000        |
| Reply Path Co-Retweet | 5     | 0.0034   | 0.75        | 0.0058         | 1.000        |
| Co-Retweet            | 6     | 0.0016   | 0.36        | 0.0026         | 1.000        |
| Quote Path Co-Retweet | 6     | 0.0016   | 0.36        | 0.0026         | 1.000        |
| Reply Path Co-Retweet | 6     | 0.0016   | 0.36        | 0.0026         | 1.000        |
