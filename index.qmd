...
In social media research, retweeters are typically conceptualized as transmission nodes that contribute to the spread of information by extending its audience reach. Much of this literature focuses on their individual-level influence and capacity for virality, often overlooking the structural roles retweeters play in shaping amplification backbones. For instance, Yan et al. (2021) examined how retweet mechanisms affect user posting and commenting behaviors using agent-based simulations, emphasizing the role of retweeting in driving user engagement. However, such studies largely neglect how retweeters collectively form structural relationships through shared amplification behaviors.

Recent work has begun to explore the structural characteristics of coordinated behavior on social media platforms. Weber and Neumann (2021) introduced a temporal window approach to identify groups of accounts engaging in highly coordinated behaviors within specific timeframes, highlighting the role of these groups in amplifying information. While this line of inquiry acknowledges the importance of coordination, it still does not fully address how retweeters build structural ties through collective behavioral patterns.

Additionally, some studies recognize that the structural configuration of retweet networks significantly influences the diffusion of information. For example, research has identified core-periphery structures within retweet networks that may lead to underestimating the actual reach of information, underscoring the importance of considering network topology in understanding amplification processes (Klein, 2022). Yet, these studies primarily focus on macro-level structural properties without explicitly examining the micro-level formation of relational ties through shared amplification behavior.

Thus, while existing literature offers valuable insights into retweeter influence and coordinated behavior, it largely overlooks the structural connections formed through shared amplification practices. This study addresses this gap by investigating how retweeters construct amplification backbone networks through collective behavioral convergence, providing a more nuanced understanding of the organizational logic underlying misinformation persistence and visibility.
...
现在我们把刚才提到的东西形成narrative：
Follower counts 极低意味着，尽管这些 retweeters共同参与了谣言放大，但他们本身没有强大的“外部传播能力”。
...
这直接支持你提出的Amplification Backbone概念，强调的是一种社会结构现象，而非流量影响力的传递。
This feature does not invalidate your network analysis; it sharpens its theoretical positioning.
