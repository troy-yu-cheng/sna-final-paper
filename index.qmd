...
<!-- ```{r} -->
<!-- model_stage1 <- ergm(co_retweet_stage_networks$Stage1 ~ edges + degree(1)) -->
<!-- summary(model_stage1) -->

<!-- # 如果有节点属性 -->
<!-- # model_stage1_attr <- ergm(co_retweet_stage_networks$Stage1 ~ edges + nodematch("group")) -->

<!-- print(co_retweet_stage_networks$Stage6) -->
<!-- prin -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- network_series <- list( -->
<!--   co_retweet_stage_networks$Stage1, -->
<!--   co_retweet_stage_networks$Stage2, -->
<!--   co_retweet_stage_networks$Stage3, -->
<!--   co_retweet_stage_networks$Stage4, -->
<!--   co_retweet_stage_networks$Stage5, -->
<!--   co_retweet_stage_networks$Stage6 -->
<!-- ) -->

<!-- lapply(network_series, gtrans) -->
<!-- ``` -->
<!-- ```{r} -->
<!-- library(tergm) -->

<!-- # Baseline Model -->
<!-- model_baseline <- tergm( -->
<!--   network_series ~ Form(~edges) + Persist(~edges), -->
<!--   estimate = "CMLE" -->
<!-- ) -->
...
<!-- summary(model_attribute) -->

<!-- model_attr <- tergm( -->
<!--   network_series ~ Form(~edges + nodematch("group")) +  -->
<!--     Persist(~edges + nodematch("group")), -->
<!--   estimate = "CMLE" -->
<!-- ) -->
<!-- list.vertex.attributes(co_retweet_stage_networks$Stage1) -->
...
<!-- ```{r} -->
<!-- # 使用 btergm 包进行 bootstrap-based TERGM -->
<!-- tergm_model <- btergm( -->
<!--   network_series ~ edges + gwesp(0.5, fixed = TRUE) + degree(1), -->
<!--   R = 500  # Bootstrap iterations, 可根据算力调整 -->
<!-- ) -->
...
<!-- ```{r} -->
<!-- tergm_model_simple <- btergm( -->
<!--   network_series ~ edges + gwesp(0.5, fixed = TRUE), -->
<!--   R = 500 -->
<!-- ) -->
<!-- summary(tergm_model_simple) -->
...
<!-- stergm_model_simple <- stergm( -->
<!--   network_series, -->
<!--   formation = ~ edges, -->
<!--   dissolution = ~ edges, -->
<!--   estimate = "CMLE" -->
<!-- ) -->
<!-- summary(stergm_model_simple) -->

<!-- stergm_model_relaxed <- stergm( -->
<!--   network_series, -->
<!--   formation = ~ edges + gwesp(0.2, fixed = TRUE), -->
<!--   dissolution = ~ edges, -->
<!--   estimate = "CMLE", -->
<!--   control = control.stergm(MCMLE.density.guard = 1000)  # 正确的控制函数 -->
<!-- ) -->
...
This study uses secondary data from the **MuMiN Project** (Multi-platform Misinformation Influence Network), publicly available at: <https://data.bris.ac.uk/datasets/23yv276we2mll25fjakkfim2ml/mumin.zip>

The dataset includes information about retweeter ids, tweets ids, misinformation claims, and the date of specific misinformation claim uttered etc.
