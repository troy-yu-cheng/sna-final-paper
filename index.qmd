...
这些“集线器”之间存在合作关系还是竞争关系？

是否形成了主干传播路径，导致某些错误信息极易被快速广泛传播？

是否有“桥梁节点”（像计算机网络的 backbone router）起到跨社群扩散的作用？

这些集线器（retweeters）是否基于特定议题聚集？形成了所谓的“信息联盟”？

Retweeter Amplification Backbone Network

Meta-Units of Amplification（Amplification Hubs）
------------------------------------------------------------------------
