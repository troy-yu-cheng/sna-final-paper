...
This study conceptualizes individual retweeters—users actively involved in the redistribution of misinformation—as foundational nodes within larger meta-networks of amplification. These retweeter-centric networks, or amplification backbones, illustrate how collective user behaviors construct structural conditions that facilitate the amplification of misinformation, independent of the message content itself (Barabási, 2016). Each retweeter is represented as a node, and edges are defined through three distinct co-retweeting behaviors based on shared and repeated amplification actions.
...
The analysis began by assessing whether direct co-retweet networks exhibit higher density than quote and reply pathway networks, as hypothesized. Visual inspection suggested slightly higher density values for direct co-retweet networks; however, a one-way ANOVA did not support this observation. The test produced an F-statistic of 0.158 with a p-value of 0.855, indicating no statistically significant differences across network types. The detailed ANOVA results are presented in Table 1.
...
The second hypothesis posited that quote pathway networks would exhibit higher local transitivity, reflecting stronger localized clustering through narrative reframing. While direct co-retweet networks again appeared to have slightly higher clustering tendencies based on descriptive statistics, this difference was not statistically significant. The ANOVA produced an F-statistic of 0.268 with a p-value of 0.769, as shown in Table 2.
...
For the third hypothesis, which anticipated higher degree centralization in reply pathway networks due to the dominance of conversational hubs, the results again revealed no significant differences. The ANOVA returned an F-statistic of 0.151 with a p-value of 0.861, indicating a lack of statistically meaningful variation in centralization across network types (Table 3).
...
The fourth hypothesis predicted that reply pathway networks would exhibit longer average path lengths due to more fragmented conversational structures. However, the ANOVA again showed no significant differences, with an F-statistic of 0.830 and a p-value of 0.455, as summarized in Table 4.
...
In addition to differences across network types, this study also examined whether structural properties varied significantly between early and late temporal stages of misinformation dissemination. Although descriptive visualizations suggested that networks formed during early stages exhibited higher density, transitivity, and centralization, Welch Two-Sample t-tests revealed no statistically significant differences across any structural metric. The detailed t-test results are presented in Table 5.

**Table 5. Welch Two-Sample t-Test Results for Temporal Changes**
...
The CUG tests revealed consistent and noteworthy patterns across all structural metrics. For density, observed values were significantly lower than those produced by random networks of the same size, with CUG probabilities indicating that the observed densities fell entirely at the lower end of the simulated distributions. This finding reflects extreme network sparsity and fragmentation, where most retweeters remain isolated or weakly connected. Such sparsity is likely the result of dispersed temporal activation patterns, as individual retweeters engage with misinformation content asynchronously across different events.

The results for transitivity highlighted a structural divergence between global and local clustering patterns. Observed global transitivity values were significantly lower than those produced by random networks, suggesting that the amplification backbones lack cohesive global connectivity. In contrast, local transitivity values were significantly higher than expected under random conditions, indicating the presence of tightly interconnected local clusters despite the overall sparsity. These findings suggest a structural pattern where small, localized amplification communities emerge among active retweeters, while large-scale, interconnected global structures do not form.

Similarly, the CUG tests for degree centralization indicated that the observed networks were significantly less centralized than random networks, pointing to a lack of dominant hub nodes. Amplification behaviors appear to be diffuse and decentralized, with no reliance on highly influential actors to drive the spread of misinformation. Finally, the CUG tests for average path length revealed that the observed networks consistently exhibited shorter path lengths than random networks. Despite their sparse and fragmented structures, these networks contain structural shortcuts that facilitate rapid information flow, possibly through strategically positioned pathways or selective activation of influential actors.

In summary, although the formal hypothesis tests failed to identify statistically significant structural differences across network types and temporal stages, the CUG analyses demonstrate that the amplification backbones possess distinctive, non-random structural configurations. These networks are characterized by extreme sparsity, low global cohesion, strong local clustering, decentralized structures, and efficient pathways for information dissemination. Such configurations suggest that the spread of misinformation is facilitated not through large, interconnected communities or centralized hubs but rather through localized coordination and strategically efficient network pathways.
