...
```{r}
# 读取数据
tweet_df <- read_csv("data/mumin_csv/tweet.csv")
tweet_claim_df <- read_csv("data/mumin_csv/tweet_discusses_claim.csv")

# 连接 tweet 和 claim
tweet_with_claim <- tweet_df |>
  inner_join(tweet_claim_df, by = c("tweet_id" = "src"))

# 查看前几行
head(tweet_with_claim)
